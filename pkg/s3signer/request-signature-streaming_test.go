...
func TestGetSeedSignature(t *testing.T) {
	...
	StreamingSignV4(req, "", secretAccessKeyID, "us-east-1", int64(dataLen), reqTime)
...
func TestChunkSignature(t *testing.T) {
	...
	actualSignature := getChunkSignature(chunkData, reqTime, location, previousSignature, secretAccessKeyID)
...
func TestSetStreamingAuthorization(t *testing.T) {
	...
	StreamingSignV4(req, accessKeyID, secretAccessKeyID, location, dataLen, reqTime)
